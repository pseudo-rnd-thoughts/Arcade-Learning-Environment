...
PYBIND11_MODULE(_ale_py, m) {
    ...
    py::class_<ale::ALEPythonInterface>(m, "ALEInterface")
        ...
        .def("act", static_cast<std::vector<ale::reward_t> (ale::ALEPythonInterface::*)(const std::vector<unsigned int>&)>(&ale::ALEPythonInterface::actMultiplayer),
            py::arg("actions"))
        .def("act", static_cast<std::vector<ale::reward_t> (ale::ALEPythonInterface::*)(const std::vector<ale::Action>&)>(&ale::ALEPythonInterface::actMultiplayer),
            py::arg("actions"))
